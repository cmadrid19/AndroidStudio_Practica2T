...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        * */
        ...
        dbw.insertarEmploeado("insert into WORKERS (first_name, last_name, email, gender, phone, location, avatar, department, language, hiring_date, birth_date) values ('Natale', 'Lagneaux', 'nlagneaux0@accuweather.com', 'Male', '437-271-7140', '870 Messerschmidt Parkway', 'https://robohash.org/totamvoluptatemvoluptate.bmp?size=250x250&set=set1', 'Accounting', 'New Zealand Sign Language', '2/2/2016', '10/18/1984')");
        dbw.insertarEmploeado("insert into WORKERS (first_name, last_name, email, gender, phone, location, avatar, department, language, hiring_date, birth_date) values ('Felipa', 'Mottershead', 'fmottershead2@examiner.com', 'Female', '552-211-4791', '90 Mallory Place', 'https://robohash.org/quocorporisoccaecati.png?size=250x250&set=set1', 'Accounting', 'West Frisian', '5/14/2011', '1/19/2000')");
        dbw.insertarEmploeado("insert into WORKERS (first_name, last_name, email, gender, phone, location, avatar, department, language, hiring_date, birth_date) values ('Tomi', 'Peele', 'tpeele3@wp.com', 'Female', '439-262-8999', '24 Anthes Crossing', 'https://robohash.org/impediteanemo.jpg?size=250x250&set=set1', 'Training', 'Czech', '7/20/2011', '2/21/1980')");
        dbw.insertarEmploeado("insert into WORKERS (first_name, last_name, email, gender, phone, location, avatar, department, language, hiring_date, birth_date) values ('Gustaf', 'Maundrell', 'gmaundrell4@flickr.com', 'Male', '770-596-4414', '37416 Wayridge Junction', 'https://robohash.org/utetconsequatur.png?size=250x250&set=set1', 'Marketing', 'Gujarati', '10/1/2011', '6/22/1985')");
        dbw.insertarEmploeado("insert into WORKERS (first_name, last_name, email, gender, phone, location, avatar, department, language, hiring_date, birth_date) values ('Mae', 'Dyka', 'mdyka5@shutterfly.com', 'Female', '402-326-5393', '15049 Ludington Crossing', 'https://robohash.org/auttemporefuga.jpg?size=250x250&set=set1', 'Sales', 'Czech', '11/16/2010', '5/3/1995')");
